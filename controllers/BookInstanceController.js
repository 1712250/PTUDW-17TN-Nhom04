...
module.exports.getBookInstance = async (id) => {
  try {
    id = mongoose.Types.ObjectId(id);
    return await Model.findById(id)
      .populate({ path: "book", populate: ["author", "genres"] })
      .exec();
  } catch (err) {
    console.log("Error while retrieving book instance! Error: " + err.message);
    return null;
  }
};
...
module.exports.getBookInstances = async (queries) => {
  try {
    ...
    console.log("Error while retrieving book instances! Error: " + err.message);
